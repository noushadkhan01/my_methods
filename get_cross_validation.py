def get_cross_validation(X, y, model, cv = 10, print_out = True, variable = True, poly_features = False):
  ...
  if variable:
    if not poly_features:
      ...
      my_global_variables.model_cross_validation[class_name + '_poly'] = {'mean':mean, 'variance': variance}
  if print_out:
